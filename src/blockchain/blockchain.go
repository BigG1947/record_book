...
func (bc *BlockChain) FillTestFeedBack() {
	...
	bc.AddBlock("Дуже чудовый выкладач! Зрозуміло виклдає і викликає зацікавленість до предмету", 12, 100, 0)
	bc.AddBlock("Викликає повагу! Ділиться чудовим досвідом про професію та сприяє професійному росту", 13, 99, 0)
	bc.AddBlock("Хорошо, добра та чутлива. Завжди допоможе кожному студенту і нікого не залишить з проблемами", 6, 99, 0)
	bc.AddBlock("Добре розуміє студентів і завжди допомогає їм", 6, 100, 0)
	bc.AddBlock("Веселий та добрий викладач. Завжди з великим задоволенням хожу на її пари", 9, 100, 0)
	bc.AddBlock("Завжди інтересно і зрозуміло викладає матеріал. Допомагає зрозуміти навіть найскладніші моменти", 9, 99, 0)
	bc.AddBlock("Завдяки їй з'явилося бажаня вкладатися у навчання!", 12, 100, 0)
}
